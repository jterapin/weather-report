...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"assets/ChickenNotHappy.png":[function(require,module,exports) {
module.exports = "/ChickenNotHappy.af7e8897.png";
},{}],"assets/ChickenHappy.png":[function(require,module,exports) {
module.exports = "/ChickenHappy.de6854ee.png";
},{}],"assets/ChickenJustRight.png":[function(require,module,exports) {
module.exports = "/ChickenJustRight.efda053b.png";
},{}],"assets/ChickenTooCold.png":[function(require,module,exports) {
module.exports = "/ChickenTooCold.65c419fd.png";
},{}],"assets/ChickenSuperCold.png":[function(require,module,exports) {
module.exports = "/ChickenSuperCold.8c198217.png";
...
var updateTempText = function updateTempText() {
...
var updateLandscape = function updateLandscape() {
  var landscapeImage = document.querySelector('#landscape-img');
  var landscapeText = document.querySelector('#landscape-text');

  if (state.temp > 80) {
    var dict = {
      key: require('/assets/ChickenNotHappy.png')
    };
    landscapeImage.src = dict.key;
    landscapeText.textContent = 'UGH TOO HOT';
  } else if (state.temp > 70) {
    var _dict = {
      key: require('/assets/ChickenHappy.png')
    };
    landscapeImage.src = _dict.key;
    landscapeText.textContent = "Let's go outside lol";
  } else if (state.temp > 60) {
    var _dict2 = {
      key: require('/assets/ChickenJustRight.png')
    };
    landscapeImage.src = _dict2.key;
    landscapeText.textContent = 'Ooo, feels nice';
  } else if (state.temp > 50) {
    var _dict3 = {
      key: require('/assets/ChickenTooCold.png')
    };
    landscapeImage.src = _dict3.key;
    landscapeText.textContent = "Where's Spring?";
  } else {
    var _dict4 = {
      key: require('/assets/ChickenSuperCold.png')
    };
    landscapeImage.src = _dict4.key;
    landscapeText.textContent = "I'm not moving";
  }
};

var updateCity = function updateCity() {
  var updatedCity = document.getElementById('cityInput');
  var currentCity = document.getElementById('currentCity');
  state.city = updatedCity.value;
  currentCity.textContent = state.city;
};

var resetCityValue = function resetCityValue() {
  var updatedCity = document.getElementById('cityInput');
  var currentCity = document.getElementById('currentCity');
  state.city = 'World';
  state.temp = 70;
...
var updateSky = function updateSky() {
  var skyValue = document.getElementById('skies').value;
...
var registerEventHandlers = function registerEventHandlers() {
  updateCity();
  var increaseTemperature = document.getElementById('tempUp');
  increaseTemperature.addEventListener('click', increaseTemp);
  var decreaseTemperature = document.getElementById('tempDown');
  decreaseTemperature.addEventListener('click', decreaseTemp);
  var cityInputUpdate = document.getElementById('cityInput');
  cityInputUpdate.addEventListener('input', updateCity);
  var requestTemp = document.getElementById('getTemp');
  requestTemp.addEventListener('click', findLatitudeAndLongitude);
  var resetCity = document.getElementById('resetCity');
  resetCity.addEventListener('click', resetCityValue);
  var selectSky = document.querySelector('#skies');
  selectSky.addEventListener('change', updateSky);
}; // DOM listener


document.addEventListener('DOMContentLoaded', registerEventHandlers);
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js","/assets/ChickenNotHappy.png":"assets/ChickenNotHappy.png","/assets/ChickenHappy.png":"assets/ChickenHappy.png","/assets/ChickenJustRight.png":"assets/ChickenJustRight.png","/assets/ChickenTooCold.png":"assets/ChickenTooCold.png","/assets/ChickenSuperCold.png":"assets/ChickenSuperCold.png"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
